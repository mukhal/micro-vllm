...
Minimal vLLM-style inference with **paged attention**: a small, readable engine for running LLM inference with block-managed KV cache. No training, no serving stack—just the core inference loop.
