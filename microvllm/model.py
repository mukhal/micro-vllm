...
- Rotary embeddings, QK norm, GQA, Flash Attention 3 / SDPA fallback
"""
...
from microvllm.attention import flash_attn
...
class CausalSelfAttention(nn.Module):
    ...
    def forward(self, x, ve, cos_sin, window_size, kv_cache, mask=None):
        B, T, C = x.size()
